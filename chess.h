...
namespace CHESS_DEFAULT{
    const QString FileNames[]={":/resource/engineer_blue.png",
                               ...
                               ":/resource/flag_blue.png",
                               ":/resource/flag_red.png",
                               ":/resource/placeholder.png", //24
                               ":/resource/placeholder_unknown.png"}; //25
...
public:
    explicit Chess(ChessBoard *pBoard,QWidget *parent=nullptr,int _type=24,int hidden=0);
